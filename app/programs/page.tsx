                ...
                <div className="px-6 py-10 text-center overflow-y-auto">
                  ...
                  <p className="text-sm text-text-muted mb-6">
                    {applyCourse.max_participants !== null && applyCourse.enrolled_count >= applyCourse.max_participants
                      ? "The programme is currently full. Your teacher can expand the group or refer you to another programme. You will hear from us by email."
                ...
                <div className="px-6 py-5 space-y-4 overflow-y-auto">
                  <div className="rounded-xl p-4 text-sm" style={{ backgroundColor: "var(--primary-light)" }}>
                    ...
                    <p className="text-text-muted">
                      {applyCourse.max_participants !== null && applyCourse.enrolled_count >= applyCourse.max_participants
                        ? "This programme is currently full. You can still apply, and the teacher can expand the group or refer you to another suitable programme."
                        : "Applying is free. If approved, you will receive an email with access to your student portal. No payment is taken through this website."}
                    </p>
                  </div>
                  <div>
        ...
        <section id="available-programs" className="pb-20 pt-16" style={{ backgroundColor: "var(--surface-muted)" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                      ...
                      {isFull && (
                        <div className="text-center py-1.5 text-xs font-semibold text-white" style={{ backgroundColor: "#F59E0B" }}>
                          Fully booked – applications are still open
                        </div>
                      )}
            ...
            <p className="text-center text-sm text-text-muted mt-8">
              Applying is free. Approved students receive access by email. No payment is taken through this website.
            </p>
          </div>
        </section>
